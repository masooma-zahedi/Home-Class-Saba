...
//   }
// ],
 داستان_خانِوادِه_ی_مَن : [
{
  fa:["زِندگیِ","مَن","با","خانِوادِه‌اَم","پُر","اَز","عِشق","و","شادی","اَست"],
  correctFa:["زِندگیِ","مَن","با","خانِوادِه‌اَم","پُر","اَز","عِشق","و","شادی","اَست"],
  en:"My life with my family is full of love and happiness"
},
{
  fa:["هَر","صُبح","ما","قَبل","اَز","شُروعِ","روز","با","هَم","صُبحانه","می‌خوریم"],
  correctFa:["هَر","صُبح","ما","قَبل","اَز","شُروعِ","روز","با","هَم","صُبحانه","می‌خوریم"],
  en:"Every morning, before starting the day, we eat breakfast together"
},
{
  fa:["ما","دَربارِه‌ی","بَرنامه‌هایِ","روزِ","خُود","حَرف","می‌زَنیم"],
  correctFa:["ما","دَربارِه‌ی","بَرنامه‌هایِ","روزِ","خُود","حَرف","می‌زَنیم"],
  en:"We talk about our plans for the day"
},
{
  fa:["ما","داستان‌هایِ","روزِ","قَبل","را","برایِ","هَم","تَعریف","می‌کُنیم"],
  correctFa:["ما","داستان‌هایِ","روزِ","قَبل","را","برایِ","هَم","تَعریف","می‌کُنیم"],
  en:"We tell each other stories from the previous day"
},
{
  fa:["بَعد","اَز","مَدرَسه","گاهی","با","هَم","بازی","می‌کُنیم"],
  correctFa:["بَعد","اَز","مَدرَسه","گاهی","با","هَم","بازی","می‌کُنیم"],
  en:"After school, sometimes we play together"
},
{
  fa:["بَعضی","روزها","به","پارک","می‌رَویم","و","قَدَم","می‌زَنیم"],
  correctFa:["بَعضی","روزها","به","پارک","می‌رَویم","و","قَدَم","می‌زَنیم"],
  en:"Some days we go to the park and walk"
},
{
  fa:["بَعضی","شَب‌ها","فیلم","تَماشا","می‌کُنیم"],
  correctFa:["بَعضی","شَب‌ها","فیلم","تَماشا","می‌کُنیم"],
  en:"Some nights we watch movies"
},
{
  fa:["گاهی","هَم","کِتاب","می‌خوانیم"],
  correctFa:["گاهی","هَم","کِتاب","می‌خوانیم"],
  en:"Sometimes we also read books"
},
{
  fa:["شامِ","خانوادگی","بِهتَرین","وَقتِ","روز","اَست"],
  correctFa:["شامِ","خانوادگی","بِهتَرین","وَقتِ","روز","اَست"],
  en:"Family dinner is the best time of the day"
},
{
  fa:["هَمه","دُورِ","میز","می‌نِشینیم"],
  correctFa:["هَمه","دُورِ","میز","می‌نِشینیم"],
  en:"Everyone sits around the table"
},
{
  fa:["ما","غَذاهایِ","خوشمَزّه","می‌خوریم"],
  correctFa:["ما","غَذاهایِ","خوشمَزّه","می‌خوریم"],
  en:"We eat delicious foods"
},
{
  fa:["مادَر","و","بابا","غَذا","دُرُست","می‌کُنَند"],
  correctFa:["مادَر","و","بابا","غَذا","دُرُست","می‌کُنَند"],
  en:"Mother and father make food"
},
{
  fa:["دَر","آخَرِ","هَفتِه","گاهی","به","جاهایِ","جَدید","می‌رَویم"],
  correctFa:["دَر","آخَرِ","هَفتِه","گاهی","به","جاهایِ","جَدید","می‌رَویم"],
  en:"On weekends, sometimes we go to new places"
},
{
  fa:["ما","اَز","موزه‌ها","دیدَن","می‌کُنیم"],
  correctFa:["ما","اَز","موزه‌ها","دیدَن","می‌کُنیم"],
  en:"We visit museums"
},
{
  fa:["گاهی","دَر","طَبیعَت","قَدَم","می‌زَنیم"],
  correctFa:["گاهی","دَر","طَبیعَت","قَدَم","می‌زَنیم"],
  en:"Sometimes we walk in nature"
},
{
  fa:["ما","عَکس","می‌گیریم","و","آلبوم","می‌سازیم"],
  correctFa:["ما","عَکس","می‌گیریم","و","آلبوم","می‌سازیم"],
  en:"We take pictures and make albums"
},
{
  fa:["ما","خاطِرِه‌هایِ","زیبایِ","خُود","را","نِگَه","می‌داریم"],
  correctFa:["ما","خاطِرِه‌هایِ","زیبایِ","خُود","را","نِگَه","می‌داریم"],
  en:"We keep our beautiful memories"
},
{
  fa:["مَن","خانِوادِه‌اَم","را","خیلی","دوست","دارَم"],
  correctFa:["مَن","خانِوادِه‌اَم","را","خیلی","دوست","دارَم"],
  en:"I love my family very much"
},
{
  fa:["آن‌ها","هَر","روز","را","خاص","و","زیبا","می‌کُنَند"],
  correctFa:["آن‌ها","هَر","روز","را","خاص","و","زیبا","می‌کُنَند"],
  en:"They make every day special and beautiful"
},
{
  fa:["ما","با","هَم","می‌خَندیم"],
  correctFa:["ما","با","هَم","می‌خَندیم"],
  en:"We laugh together"
},
{
  fa:["ما","به","هَم","کُمَک","می‌کُنیم"],
  correctFa:["ما","به","هَم","کُمَک","می‌کُنیم"],
  en:"We help each other"
},
{
  fa:["ما","خاطِرِه‌هایِ","قَشَنگی","می‌سازیم"],
  correctFa:["ما","خاطِرِه‌هایِ","قَشَنگی","می‌سازیم"],
  en:"We make beautiful memories"
},
{
  fa:["این","خاطِرِه‌ها","هَمیشِه","دَر","یادِ","مَن","می‌مانَد"],
  correctFa:["این","خاطِرِه‌ها","هَمیشِه","دَر","یادِ","مَن","می‌مانَد"],
  en:"These memories always stay in my mind"
}
],
  };
