...
// احساسات غذا
{
  ...
  slides: [
    ...
    {
      sentence: "پِسَر از طَعَمِ تُندِ غذا صورَتش سُرخ شَد و آبِ زیادی خورد.",
      words: [
    ...
    {
      sentence: "بَچِّه اَز این غذا بَدَش آمَد و ناراحت شُد.",
      words: [
    ...
    {
      sentence: "کودَک بَعد اَز خوردنِ زیاد دُچارِ دِل‌دِرد شُد.",
      words: [
    ...
    {
      sentence: "دُختَر از خُوردنِ سوپِ خوش‌طَعم لَذّت بُرد.",
      words: [
        { text: "لذت", pronunciation: "lezat", image: "https://thumbs.dreamstime.com/b/girl-eating-soup-spoon-cheerful-young-enjoys-bowl-green-displaying-happy-expression-seated-table-perfect-419464250.jpg", translation: "Enjoyment" }
      ]
    },
    {
...
const SentenceObject = () => {
  ...
  const [mainTitle, setMainTitle] = useState("احساس خوردن");
