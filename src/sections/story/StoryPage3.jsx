...
const StoryPage = ({ title, content, vocab, qa ,goalGroup}) => {
  ...
  return (
    <div className="p-2  border rounded shadow-sm bg-light" dir="rtl">
      <div className='text-primary h3 mb-5 d-inline-block p-2 mb-3 border-bottom border-info'>روان خوانی:{goalGroup}</div>
...
// کامپوننت اصلی
// StoryPage3.jsx
function StoryPage3({ groupKey = 'alefba', wantedTitle ,goalGroup = ''}) {
  ...
  return (
    <div className="container mt-4">
      {currentStory ? (
        <StoryPage {...currentStory} goalGroup={goalGroup} />
      ) : (
