...
export default function Home() {
  return (<>
  <div  className="">
    <div className="h5 container  m-2 rounded text-center p-3 text-light" style={{backgroundColor: " #992988"}}>بچه ها جملات زیر را بخوانند و از روی 5 جمله آن بنویسند. </div>
    ...
    {/* <SpellingGame/> */}
        ...
        {/* <TypingQAImageSlider/> */}
    {/* <SentenceBuilder/> */}
    <StoryPage3 groupKey="alefba" wantedTitle="چوپان دروغ‌گو" goalGroup="" />
