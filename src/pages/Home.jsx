...
export default function Home() {
  ...
  <div  className="">
    ...
    {/* <SpellingGame/> */}
        ...
        <div className="h5 container m-2 rounded text-center mt-4 p-1 py-3 text-light" style={{backgroundColor: " rgb(86, 134, 202)"}}> گروه کلمات : بچه ها داستان بالا را بخوانند و خلاصه داستان را بنویسند. </div>
        {/* <TypingQAImageSlider/> */}
